...
#searchFormOrder input{
    ...
    <!-- Main content -->
    <form id="searchFormOrder" action="{{route('searchNew')}} " method="GET">
            ...
            <tr>
                @foreach ($data as $booking)
                    ...
                    <td class="text-right">
                        ...
                        <a
                            href="{{ route('bookingConfirm', ['id' => $booking->id]) }}"class="btnConfirm btn btn-sm btn-warning">
                           Xác nhận đặt phòng
                        </a>
                        <a href="{{ route('bookingRefuse', ['id' => $booking->id]) }}"class="btnDelete btn btn-sm btn-danger">
                           Từ chối đặt phòng
                        </a>
    ...
    <form action="" method="GET" id="form-cofirm">
        @csrf @method('UPDATE')
    </form>
@stop
@section('js')
...
<script>
    $(document).ready(function() {
        $(".btnDelete").click(function() {
            ...
            if (confirm('Bạn có chắc muốn từ chối đơn này không?')) {
    ...
    <script>
        $(document).ready(function() {
            $(".btnConfirm").click(function() {
                event.preventDefault();
                var _href = $(this).attr('href');
                $('form#form-cofirm').attr('action', _href);
                if (confirm('Bạn có chắc muốn xác nhận room này không?')) {
                    $('form#form-cofirm').submit();
                }
            });
        });
    </script>
